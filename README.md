...
The goal of the project is to model broad-scale environmental suitability for dengue vectors using presence-only data and a transparent, fully documented MaxEnt workflow. This is a work in progress.
